...
const Bubble17 = ({ title = "button - 17" }) => {
  return (
    <div className="relative group cursor-pointer">
      ...
      <div className="absolute inset-0 w-24 h-24 rounded-full bg-gradient-to-r from-zinc-400 to-neutral-400 opacity-0 group-hover:opacity-60 scale-100 group-hover:scale-[4] transition-all duration-1000 ease-out blur-sm"></div>
      <div className="absolute inset-0 w-24 h-24 rounded-full bg-gradient-to-r from-zinc-300 to-neutral-300 opacity-0 group-hover:opacity-40 scale-100 group-hover:scale-[3] transition-all duration-800 ease-out blur-sm delay-100"></div>
      <div className="absolute inset-0 w-24 h-24 rounded-full bg-gradient-to-r from-zinc-200 to-neutral-200 opacity-0 group-hover:opacity-30 scale-100 group-hover:scale-[2] transition-all duration-600 ease-out blur-sm delay-200"></div>
