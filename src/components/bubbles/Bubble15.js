...
const Bubble15 = ({ title = "button - 15" }) => {
  return (
    <div className="relative group cursor-pointer">
      ...
      {/* Main bubble */}
      <div className="relative z-10 bg-gradient-to-br from-amber-400 to-amber-600 w-24 h-24 rounded-full shadow-xl hover:shadow-2xl transition-all duration-500 ease-out hover:scale-110 flex items-center justify-center group-hover:animate-pulse">
